...
module Admin
    ...
    def edit
        @deadline = Setting.find_or_initialize_by(key: 'group_creation_deadline')
        @project_deadline = Setting.find_or_initialize_by(key: 'project_selection_deadline')
    ...
    def export_unassigned_students
        @deadline = Setting.find_by(key: 'group_creation_deadline')
        @students_without_group = unassigned_students
    ...
    def unassigned_students
        deadline = Setting.find_by(key: 'group_creation_deadline')&.value
